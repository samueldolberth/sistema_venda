...
public class view_login extends javax.swing.JFrame {
    ...
    private void logar() {
        try {
            ...
            UsuarioDAO usuariodao = new UsuarioDAO(connection); //instrnaicia o usuario DAO
            ResultSet rsusuariodao = usuariodao.autenticaUsuario(usuario);
            ...
            JOptionPane.showMessageDialog(null, "view_login" + erro);
        }

 ...
 * @author Adm
 */
public class view_cadastro_usuario1 extends javax.swing.JFrame {

    /**
     * Creates new form view_cadastro_usuario1
     */
    public view_cadastro_usuario1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Padrão", "Item 2", "Item 3", "Item 4" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_cadastro_usuario1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new view_cadastro_usuario1().setVisible(true);
            }
        });
    }
